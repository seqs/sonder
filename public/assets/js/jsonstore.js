(function($) {
  ...
  var app = $.sammy('#main', function() {
    ...
    this.around(function(callback) {
      var context = this;
      this.load('/assets/data/items.json')
          .then(function(items) {
            context.items = items;
          })
          .then(callback);
    ...
    this.get('#/', function(context) {
      ...
      $.each(this.items, function(i, item) {
        context.render('/assets/tpl/jsonstore/item.template', {id: i, item: item})
    ...
    this.get('#/item/:id', function(context) {
      ...
      this.partial('/assets/tpl/jsonstore/item_detail.template');
    });
